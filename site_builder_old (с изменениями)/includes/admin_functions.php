       ...
       /* echo '
         ...
         */
         ...
         $_val = str_replace('"','\'',$_val);
          ...
          echo '<input type="hidden" id="'.$_var.'" name="'.$_var.'" value="'.$_val.'">
          <input type="hidden" id="'.$_var.'___Config" value="" style="display:none" />
         <iframe id="'.$_var.'___Frame" src="/fckeditor/editor/fckeditor.html?InstanceName='.$_var.'&amp;Toolbar=Default" width="720" height="300" frameborder="0" scrolling="no"></iframe>';
